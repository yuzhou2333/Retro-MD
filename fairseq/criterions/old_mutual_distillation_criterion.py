...
#             if lang_pair not in self.RS_valid_loss1:
#                 return 0.5, 0.5
#             student_RS_valid_loss = self.RS_valid_loss2[lang_pair] if student_is_model2 else self.RS_valid_loss1[lang_pair]
#             teacher_RS_valid_loss = self.RS_valid_loss1[lang_pair] if student_is_model2 else self.RS_valid_loss2[lang_pair]
#             if student_RS_valid_loss - teacher_RS_valid_loss > 0.5:
#                 return 1, 0
#             elif teacher_RS_valid_loss - student_RS_valid_loss > 0.5:
#                 return 0, 1
#             else:
#                 with torch.no_grad():
#                     return (torch.tensor(
#                         [student_RS_valid_loss, teacher_RS_valid_loss]
...
#
#     def update_RS_valid_loss(self, RS_valid_loss, is_model2):
#         if is_model2:
#             self.RS_valid_loss2 = RS_valid_loss
#         else:
#             self.RS_valid_loss1 = RS_valid_loss

    # def get_switch_status(self, lang_pair, student_is_model2):
    #     student_RS_valid_loss = self.RS_valid_loss2[lang_pair] if student_is_model2 else self.RS_valid_loss1[lang_pair]
    #     teacher_RS_valid_loss = self.RS_valid_loss1[lang_pair] if student_is_model2 else self.RS_valid_loss2[lang_pair]
    #     return (student_RS_valid_loss - teacher_RS_valid_loss) + self.distillation_threshold > 0
