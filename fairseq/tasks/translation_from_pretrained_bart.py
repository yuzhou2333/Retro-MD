...
class TranslationFromPretrainedBARTTask(TranslationTask):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        # infer langcode
        src, tgt = self.args.source_reaction, self.args.target_reaction
    ...
    def build_generator(self, models, args, **unused):
        if getattr(args, "score_reference", False):
            ...
            return SequenceScorer(
                ...
                eos=self.tgt_dict.index("[{}]".format(self.args.target_reaction)),
            )
        else:
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, constraints=None):
        src_lang_id = self.source_dictionary.index("[{}]".format(self.args.source_reaction))
        source_tokens = []
