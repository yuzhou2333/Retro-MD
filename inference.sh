...
TOP_K="${TOP_K:-${3:-10}}"
CHECKPOINT="${CHECKPOINT:-${PROJECT_DIR}/save_models/Retro_MD/checkpoint_best.pt}"
DATA_BIN="${DATA_BIN:-${PROJECT_DIR}/data_bin/uspto50k_aug20}"
REACTION_DICT="${REACTION_DICT:-${DATA_BIN}/reaction_list.txt}"
TARGETS="${TARGETS:-all}"
SOURCE_TEMPLATE="${SOURCE_TEMPLATE:-src{target}}"
LANG_ARG_STYLE="${LANG_ARG_STYLE:-reaction}"
